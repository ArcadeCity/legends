...
import {
  GeoBox, OrientedBox3, Projection, TileKey, TilingScheme, webMercatorTilingScheme
...
export class DecodeInfo {
  ...
  constructor(
    ...
    this.rowCount = webMercatorTilingScheme.subdivisionScheme.getLevelDimensionY(this.tileKey.level)
  }
