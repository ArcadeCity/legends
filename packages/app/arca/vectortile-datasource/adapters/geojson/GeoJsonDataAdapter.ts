...
import { ValueMap } from 'app/arca/datasource-protocol'
import { clipLineString } from 'app/arca/geometry'
import { GeoCoordinates, GeoPointLike, Vector2Like, webMercatorProjection } from 'app/arca/geoutils'
...
function convertLineStringGeometry(
  ...
  const positions = coordinates.map((geoPoint) => convertPoint(geoPoint, decodeInfo, new Vector2()))
