...
import {
  equirectangularProjection, mercatorProjection, normalizedEquirectangularProjection, OrientedBox3,
  Projection, sphereProjection, Vector3Like, webMercatorProjection
} from 'app/arca/geoutils'
import { Env } from './Expr'
import { AttrEvaluationContext, evaluateTechniqueAttr } from './TechniqueAttr'
import {
  IndexedTechnique, isLineMarkerTechnique, isPoiTechnique, isTextTechnique, Technique
} from './Techniques'
...
export interface DecodedTile {
  ...
  /**
   * List of {@link app/arca/geoutils#TileKey}s stored as mortonCodes representing
   * {@link app/arca/mapview#Tile}s that have geometry covering this `Tile`.
   */
  dependencies?: number[]
}
