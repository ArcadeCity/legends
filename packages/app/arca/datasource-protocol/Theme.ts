 ...
 */
import { Vector3Like } from '../geoutils'
import { JsonExpr, JsonValue } from './Expr'
import { InterpolatedPropertyDefinition } from './InterpolatedPropertyDefs'
import {
  BaseTechniqueParams, BasicExtrudedLineTechniqueParams, ExtrudedPolygonTechniqueParams, FillTechniqueParams,
  LineTechniqueParams, MarkerTechniqueParams, Pickability, PointTechniqueParams, SegmentsTechniqueParams,
  ShaderTechniqueParams, SolidLineTechniqueParams, StandardExtrudedLineTechniqueParams,
  StandardTechniqueParams, TerrainTechniqueParams, TextTechniqueParams
 ...
 * {@link app/arca/mapview#DataSource} should be rendered.
 *
 * @remarks
 ...
 * {@link app/arca/mapview#MapView} via {@link app/arca/mapview#MapViewtheme}.
 */
export type Styles = Style[]

/**
 * The object that defines what way an item of a {@link app/arca/mapview#DataSource}
