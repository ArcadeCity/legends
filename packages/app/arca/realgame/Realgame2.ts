...
import { AtmosphereLightMode, MapAnchor, MapViewAtmosphere, MapViewEventNames } from 'app/arca/mapview'
...
export default class Realgame {
  ...
  constructor(options: RealgameOptions) {
  ...
  public flyToLatLon(lat, lon) {
    ...
    console.log('skipping flyto here')
  ...
  private initializeMap() {
    ...
    this.mapView.addEventListener(MapViewEventNames.DataSourceConnect, () => {
    ...
    console.log('Realgame map initialized')
