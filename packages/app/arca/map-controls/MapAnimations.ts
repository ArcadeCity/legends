...
import { GeoCoordinates, GeoCoordinatesLike } from 'app/arca/geoutils'
import { MapView } from 'app/arca/mapview'
import { PerformanceTimer } from 'app/arca/utils'
...
export class CameraRotationAnimation extends CameraAnimation {
  ...
  start(time?: number, onFinished?: () => void): void {
    ...
    if (this.m_mapControls) {
      ...
      this.m_mapControls.addEventListener(EventNames.EndInteraction, this.endInteractionListener)
    }
  ...
  stop(): void {
    ...
    if (this.m_mapControls) {
      ...
      this.m_mapControls.removeEventListener(EventNames.EndInteraction, this.endInteractionListener)
    }
  }
