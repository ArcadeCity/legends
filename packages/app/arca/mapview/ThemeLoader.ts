...
import {
  Definitions, getDefinitionValue, getStyles, ImageTexture, isJsonExpr, isJsonExprReference,
  isStylesDictionary, Style, Styles, Theme
} from 'app/arca/datasource-protocol'
import {
  composeUriResolvers, ContextLogger, getAppBaseUrl, getOptionValue, IContextLogger, ISimpleChannel,
...
/**
 * Options to customize {@link app/arca/datasource-protocol#Theme} loading process.
 *
...
export interface ThemeLoadOptions {
   ...
   * through [{@link app/arca/datasource-protocol#Theme}s `extends` property.
   *
...
export class ThemeLoader {
  /**
   * Loads a {@link app/arca/datasource-protocol#Theme} from a
   ...
   * providing {@link app/arca/utils#UriResolver} using {@link ThemeLoadOptions.uriResolver}
   * option.
   *
   * @param theme - {@link app/arca/datasource-protocol#Theme} instance or theme URL
   *                to the theme.
   ...
   *
   * Loads a {@link app/arca/datasource-protocol#Theme} from a remote resource,
  ...
  /**
   * Resolves all {@link app/arca/datasource-protocol#Theme}'s relatives URLs
   * to full URL using the {@link app/arca/datasource-protocol#Theme}'s URL
   * (see: https://www.w3.org/TR/WD-html40-970917/htmlweb.html#h-5.1.2).
   *
   * This method mutates original `theme` instance.
   *
   * @param theme - The {@link app/arca/datasource-protocol#Theme} to resolve.
   */
  ...
  /**
   * Expand all `ref` expressions in {@link app/arca/datasource-protocol#Theme}
   ...
   * its base {@link app/arca/datasource-protocol#Theme}.
   *
   * @param theme - {@link app/arca/datasource-protocol#Theme} object
   * @param options - Optional, a {@link ThemeLoadOptions} objects
   *                  containing any custom settings for
   *                  this load request.
   */
  private static async resolveBaseThemes(theme: Theme, options?: ThemeLoadOptions): Promise<Theme> {
    options = options ?? {}
