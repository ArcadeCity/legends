...
import {
  AttributeMap, composeTechniqueTextureName, DecodedTile, ImageTexture, IndexedTechnique,
  isLineMarkerTechnique, isPoiTechnique, MapEnv, PoiGeometry
} from 'app/arca/datasource-protocol'
import { assert, assertExists, LoggerManager } from 'app/arca/utils'
...
/**
 * Interface for the {@link app/arca/datasource-protocol#ImageTexture}s
 ...
 * {@link app/arca/datasource-protocol#PoiGeometry} objects
 * from the {@link app/arca/datasource-protocol#DecodedTile},
...
export class PoiManager {
   ...
   */
  private static notifyMissingPoiTable(poiTableName: string, poiTable: PoiTable | undefined): void {
   ...
   *                      {@link app/arca/datasource-protocol#PoiGeometry}
   ...
   *
   * @remarks
   * Creates an {@link app/arca/datasource-protocol#ImageTexture}
  ...
  /**
   * Add an {@link app/arca/datasource-protocol#ImageTexture} such that it
   * is available as a named entity for techniques in theme files.
   *
   * @param imageTexture - {@link app/arca/datasource-protocol#ImageTexture}
  ...
  /**
   * Return the {@link app/arca/datasource-protocol#ImageTexture}
   * registered under the specified name.
   *
   * @param name - Name of the {@link app/arca/datasource-protocol#ImageTexture}.
   */
