...
import {
  composeTechniqueTextureName, Env, getPropertyValue, IndexedTechniqueParams, LineMarkerTechnique, MapEnv,
  PoiTechnique
...
/**
 * Constructs {@link PoiInfo} objects from {@link app/arca/datasource-protocol/Technique} and
 * an icon.
 */
export class PoiBuilder {
  ...
  build(textElement: TextElement): PoiInfo | undefined {
    ...
    const iconColor = iconColorRaw !== null ? ColorCache.instance.getColor(iconColorRaw) : undefined
