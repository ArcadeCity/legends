 ...
 */
import { MemoryUsage } from 'app/arca/text-canvas'
...
export class BoxBuffer {
  /**
   * {@link app/arca/datasource-protocol#BufferAttribute} holding the `BoxBuffer` position data.
   */
  private m_positionAttribute?: THREE.BufferAttribute

  /**
   * {@link app/arca/datasource-protocol#BufferAttribute} holding the `BoxBuffer` color data.
   */
  private m_colorAttribute?: THREE.BufferAttribute

  /**
   * {@link app/arca/datasource-protocol#BufferAttribute} holding the `BoxBuffer` uv data.
   */
  private m_uvAttribute?: THREE.BufferAttribute

  /**
   * {@link app/arca/datasource-protocol#BufferAttribute} holding the `BoxBuffer` index data.
   */
   ...
   * {@link app/arca/datasource-protocol#BufferAttribute}s.
   */
  ...
  /**
   * Creates a new {@link app/arca/datasource-protocol#Geometry} object
  ...
  private resizeBuffer(newSize: number) {
    ...
    const newIndexArray =
      numIndexValues > 65535 ? new Uint32Array(numIndexValues) : new Uint16Array(numIndexValues)
