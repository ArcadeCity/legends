 ...
 */
import { Env, getPropertyValue, ImageTexture } from 'app/arca/datasource-protocol'
import { IconMaterial } from 'app/arca/materials'
import { MemoryUsage } from 'app/arca/text-canvas'
import { assert, LoggerManager, Math2D } from 'app/arca/utils'
 ...
 * ({@link app/arca/datasource-protocol#ImageTexture}).
 *
...
export class PoiRenderer {
   ...
   * @param imageTexture - Shared {@link app/arca/datasource-protocol#ImageTexture},
