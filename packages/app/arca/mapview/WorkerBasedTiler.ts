...
import { GeoJson, ITiler, WorkerServiceProtocol, WorkerTilerProtocol } from 'app/arca/datasource-protocol'
...
export class WorkerBasedTiler implements ITiler {
   ...
   *
   * @param indexId - Index identifier.
   * @param tileKey - The {@link app/arca/geoutils#TileKey} that identifies the tile.
   */
