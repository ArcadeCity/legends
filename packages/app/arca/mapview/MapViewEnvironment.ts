import { GradientSky, Light, Sky } from 'app/arca/datasource-protocol'
import { ProjectionType, Vector3Like } from 'app/arca/geoutils'
...
export class MapViewEnvironment {
  ...
  constructor(private readonly m_mapView: MapView, options: MapViewEnvironmentOptions) {
    ...
    if (options.backgroundTilingScheme !== undefined && this.m_backgroundDataSource !== undefined) {
