 ...
 */
import {
  DecodedTile, DecoderOptions, getProjectionName, ITileDecoder, OptionsMap, RequestController, TileInfo,
  WorkerDecoderProtocol, WorkerServiceProtocol
...
export class WorkerBasedDecoder implements ITileDecoder {
   ...
   *
   * @remarks
   * Invokes {@link app/arca/datasource-protocol#DecodeTileRequest} on
  ...
  /**
   * Get {@link app/arca/datasource-protocol#TileInfo} from tile decoder service in worker.
   *
   * @remarks
   * Invokes {@link app/arca/datasource-protocol#TileInfoRequest}
   ...
   *
   * @remarks
   * Broadcasts {@link app/arca/datasource-protocol#ConfigurationMessage}
