...
import { Theme } from 'app/arca/datasource-protocol'
import { EarthConstants, Projection, ProjectionType } from 'app/arca/geoutils'
import { GroundAtmosphereMaterial, SkyAtmosphereMaterial } from 'app/arca/materials'
...
export class MapViewAtmosphere {
   ...
   * {@link app/arca/datasource-protocol#Theme} instance provided.
   *
   ...
   *
   * @param theme - A {@link app/arca/datasource-protocol#Theme} instance.
   */
  reset(theme: Theme) {
