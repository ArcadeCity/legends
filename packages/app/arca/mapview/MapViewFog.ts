import { Fog } from 'app/arca/datasource-protocol'
import { HighPrecisionLineMaterial, RawShaderMaterial } from 'app/arca/materials'
import { assert, MathUtils } from 'app/arca/utils'
/*
...
export class MapViewFog {
  ...
  /**
   * Sets the fog depending on the {@link app/arca/datasource-protocol#Theme}
