 ...
 */
import { DecodedTile, GeometryKindSet, GeometryType, TextPathGeometry } from 'app/arca/datasource-protocol'
import { assert, CachedResource, chainCallbacks, LoggerManager } from 'app/arca/utils'
import * as THREE from 'three'
import { GeoBox, OrientedBox3, Projection, TileKey, TileKeyUtils } from '../geoutils'
...
export class Tile implements CachedResource {
  ...
  private readonly m_elevationRange: ElevationRange = {
    minElevation: 0,
    maxElevation: 0,
  }
  ...
  /**
   * The {@link app/arca/geoutils#Projection} currently used by the {@link MapView}.
   */
   ...
   * The {@link app/arca/datasource-protocol#DecodedTile} is still available.
   */
