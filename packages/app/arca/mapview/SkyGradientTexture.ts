...
import { GradientSky } from 'app/arca/datasource-protocol'
import { ProjectionType } from 'app/arca/geoutils'
import { getOptionValue } from 'app/arca/utils'
...
export class SkyGradientTexture {
  ...
  constructor(
    ...
    if (this.m_projectionType === ProjectionType.Spherical) {
      ...
      this.m_farClipPlaneCorners = [new Vector3(), new Vector3(), new Vector3(), new Vector3()]
    }
  }
