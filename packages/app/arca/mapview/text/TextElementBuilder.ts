...
import {
  AttributeMap, Env, getFeatureId, getPropertyValue, IndexedTechniqueParams, isTextTechnique,
  LineMarkerTechnique, MapEnv, PoiTechnique, TextTechnique
} from 'app/arca/datasource-protocol'
import { ContextualArabicConverter, TextLayoutStyle, TextRenderStyle } from 'app/arca/text-canvas'
import { assert, LoggerManager, MathUtils } from 'app/arca/utils'
...
/**
 * Constructs {@link TextElement} objects from {@link app/arca/datasource-protocol/Technique},
...
export class TextElementBuilder {
  ...
  static alignZoomLevelRanges(textElement: TextElement): void {
    ...
    textElement.minZoomLevel =
      textElement.minZoomLevel ?? MathUtils.min2(poiInfo.iconMinZoomLevel, poiInfo.textMinZoomLevel)

    textElement.maxZoomLevel =
      textElement.maxZoomLevel ?? MathUtils.max2(poiInfo.iconMaxZoomLevel, poiInfo.textMaxZoomLevel)
  }
   ...
   * Constructor
   *
   * @param m_env - The {@link @link app/arca/datasource-protocol#MapEnv} used to evaluate
   * technique properties.
   * @param m_styleCache - To cache instances of {@link app/arca/text-canvas/TextRenderStyle}
   * and {@link app/arca/text-canvas/TextLayoutStyle}.
   */
  constructor(
   ...
   *
   * @param technique - The {@link app/arca/datasource-protocol/Technique}.
   * @return This builder.
   */
  withTechnique(
