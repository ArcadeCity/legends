...
import { Env, getPropertyValue, PoiTechnique } from 'app/arca/datasource-protocol'
import { OrientedBox3, Projection, ProjectionType } from 'app/arca/geoutils'
import {
  hAlignFromPlacement, HorizontalPlacement, hPlacementFromAlignment, MeasurementParameters, TextCanvas,
  TextPlacement, vAlignFromPlacement, VerticalPlacement, vPlacementFromAlignment
} from 'app/arca/text-canvas'
import { assert, Math2D, MathUtils } from 'app/arca/utils'
 ...
 * @param env - The {@link app/arca/datasource-protocol#Env} used
 ...
 * @param scale - Scale factor to be applied to label dimensions.
 * @param textCanvas - The text canvas where the label will be placed.
 * @param env - The {@link app/arca/datasource-protocol#Env}
