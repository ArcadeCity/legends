...
import {
  GeometryKind, GeometryKindSet, ImageTexture, LineMarkerTechnique, PoiStackMode, PoiTechnique
} from 'app/arca/datasource-protocol'
import {
  GlyphData, TextBufferObject, TextLayoutParameters, TextLayoutStyle, TextRenderParameters, TextRenderStyle
} from 'app/arca/text-canvas'
import { Math2D } from 'app/arca/utils'
...
export interface PoiInfo {
  ...
  /**
   * Name of the {@link app/arca/datasource-protocol#ImageTexture} or image in
   * {@link app/arca/mapview#userImageCache}.
   */
   ...
   * Icon color override
   *
   * @see {@link app/arca/datasource-protocol#MarkerTechniqueParams.iconColor};
   */
   ...
   * Icon brightness.
   *
   * @see {@link app/arca/datasource-protocol#MarkerTechniqueParams.iconBrightness};
   */
  ...
  /**
   * @hidden
   * Direct access to {@link app/arca/datasource-protocol#ImageTexture} once it is resolved.
   */
...
export class TextElement {
  ...
  /**
   * @hidden
   * Array storing the style {@link app/arca/text-canvas#GlyphData} for
