...
import { Vector3Like } from 'app/arca/geoutils'
import { sampleBilinear } from 'app/arca/utils'
...
export class DisplacedBufferAttribute extends THREE.BufferAttribute {
  ...
  private displacePosition(bufferIndex: number) {
    this.m_lastPos.fromBufferAttribute(this.originalAttribute as THREE.BufferAttribute, bufferIndex)
