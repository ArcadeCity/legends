 ...
 */
import {
  DecodedTile, GeometryKind, GeometryKindSet, isExtrudedLineTechnique, isExtrudedPolygonTechnique,
  isFillTechnique, isLineMarkerTechnique, isLineTechnique, isPoiTechnique, isSegmentsTechnique,
  isSolidLineTechnique, isTextTechnique, Technique
} from 'app/arca/datasource-protocol'
import { PerformanceTimer, TaskQueue } from 'app/arca/utils'
...
export class TileGeometryLoader {
  ...
  /**
   * Set the {@link app/arca/datasource-protocol#DecodedTile} of the tile.
   *
   * @remarks
