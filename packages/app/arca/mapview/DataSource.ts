import { ExprPool, Theme, ValueMap } from 'app/arca/datasource-protocol'
import { Projection, TileKey, TilingScheme } from 'app/arca/geoutils'
...
export abstract class DataSource extends THREE.EventDispatcher {
  ...
  /**
   * The {@link app/arca/geoutils#Projection} used by
   * the {@link MapView} that is holding this `DataSource`.
   *
  ...
  /**
   * Returns the {@link app/arca/geoutils#TilingScheme} used by this `DataSource`.
   */
  ...
  /**
   * Apply the {@link app/arca/datasource-protocol#Theme} to this data source.
   *
   ...
   * {@link app/arca/geoutils#TileKey}.
   *
   ...
   * given {@link app/arca/geoutils#TileKey} and zoom level.
   *
   * @param zoomLevel - The zoom level of the {@link MapView}.
   * @param tileKey - The unique identifier for a map tile.
   * @returns `true` if the tile for the given {@link app/arca/geoutils#TileKey} can be loaded.
   */
   ...
   * further with given {@link app/arca/geoutils#TileKey} and
   * zoom level.
   *
   * @param zoomLevel - The zoom level of the {@link MapView}.
   * @param tileKey - The unique identifier for a map tile.
   * @returns `true` if the subtiles of the given {@link app/arca/geoutils#TileKey} should be
   ...
   * elements with the given {@link app/arca/geoutils#TileKey} and
   * zoom level.
   *
   * @remarks
   ...
   *          given {@link app/arca/geoutils#TileKey} should be rendered.
   */
