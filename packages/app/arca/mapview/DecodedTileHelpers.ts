...
import {
  BufferAttribute, ColorUtils, Env, Expr, getPropertyValue, getTechniqueAutomaticAttrs,
  getTechniqueDescriptor, isExtrudedLineTechnique, isExtrudedPolygonTechnique, isShaderTechnique,
  isTextureBuffer, parseStringEncodedColor, ShaderTechnique, supportsTextures, Technique,
  TEXTURE_PROPERTY_KEYS, TextureBuffer, TextureProperties, TRANSPARENCY_PROPERTY_KEYS, Value
} from 'app/arca/datasource-protocol'
import {
  CirclePointsMaterial, disableBlending, enableBlending, HighPrecisionLineMaterial, MapMeshBasicMaterial,
  MapMeshStandardMaterial, RawShaderMaterial, SolidLineMaterial
} from 'app/arca/materials'
import { assert, LoggerManager, pick } from 'app/arca/utils'
 ...
 * {@link app/arca/datasource-protocol#BufferAttribute} object.
 *
 ...
 * @param env - {@link app/arca/datasource-protocol#Env} instance
 *              used to evaluate {@link app/arca/datasource-protocol#Expr}
 ...
 * @param env - {@link app/arca/datasource-protocol#Env} instance used
 *              to evaluate {@link app/arca/datasource-protocol#Expr}
 *              based properties of [[Technique]]
 */
 ...
 * @param env - {@link app/arca/datasource-protocol#Env} instance used to evaluate
 *              {@link app/arca/datasource-protocol#Expr} based properties of [[Technique]]
 *
 * @internal
 */
