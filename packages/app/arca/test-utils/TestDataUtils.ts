 ...
 *
 * @param moduleName -: module name, `@here/<module_name>` (e.g. app/arca/vectortile-datasource)
 ...
 *
 * @param module -: module name, @here/<module_name> (e.g. app/arca/vectortile-datasource)
 * @param fileName -: the requested resource
 *                  (e.g. app/arca/vectortile-datasource/test/resources/berlin.bin)
 */
