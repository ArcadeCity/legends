...
import { LineCaps, LineDashes } from 'app/arca/datasource-protocol'
...
import {
  RawShaderMaterial, RawShaderMaterialParameters, RendererMaterialParameters
} from './RawShaderMaterial'
import linesShaderChunk, { LineCapsModes } from './ShaderChunks/LinesChunks'
import { enforceBlending, getShaderMaterialDefine, setShaderDefine, setShaderMaterialDefine } from './Utils'
