...
// import { VehicleEntryInstance } from '@/sketchbook/ts/characters/VehicleEntryInstance'
...
export class Character extends THREE.Object3D implements IWorldEntity {
  ...
  constructor(gltf: any) {
    ...
    this.modelContainer.scale.setScalar(2)
  ...
  public springRotation(timeStep: number): void {
    ...
    let angle
    try {
      angle = Utils.getSignedAngleBetweenVectors(this.orientation, this.orientationTarget)
    } catch (e) {
      return
    }
  ...
  public update(timeStep: number): void {
    ...
    // this.vehicleEntryInstance?.update(timeStep) // CD
